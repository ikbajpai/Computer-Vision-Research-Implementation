...
def vgg11(num_classes=1000, batch_norm=False):
    return VGG(make_layers(cfgs["A"], batch_norm=batch_norm), num_classes=num_classes)


def vgg13(num_classes=1000, batch_norm=False):
    return VGG(make_layers(cfgs["B"], batch_norm=batch_norm), num_classes=num_classes)
